      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-cream/80 text-lg leading-relaxed mb-6">
              Specializzati nel trattamento osteopatico dell'emicrania e delle disfunzioni 
        ...
        >
          ...
          <p className="text-cream/60 text-xs mt-2">
            Trattamento osteopatico specializzato per emicrania e disfunzioni posturali
          </p>
        </motion.div>
      </div>
    </footer>
