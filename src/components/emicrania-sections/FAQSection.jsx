  ...
  const faqs = [
    {
      ...
      answer: "Il trattamento osteopatico ha una durata di circa 60 minuti. Questo tempo ci permette di svolgere un'accurata anamnesi, una valutazione posturale completa e il trattamento osteopatico specifico per il tuo caso, garantendo la massima efficacia terapeutica."
    },
    {
      icon: Shirt,
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-blue-dark/80 max-w-3xl leading-relaxed">
            Tutte le risposte che ti servono per iniziare il tuo percorso verso la libertà dall'emicrania.
          </p>
        </motion.div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-cream rounded-xl border border-blue-dark/10 hover:border-green/30 transition-all duration-300 overflow-hidden"
            >
              {/* Question */}
              <button
