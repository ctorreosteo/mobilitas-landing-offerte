...
export default function WhatsAppButtonEmicrania() {
  const handleWhatsAppClick = () => {
    const phoneNumber = '393518198457' // Numero senza + e spazi
    const message = encodeURIComponent('Ciao, vorrei avere maggiori informazioni sul trattamento osteopatico per l\'emicrania')
