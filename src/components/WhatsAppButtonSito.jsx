...
export default function WhatsAppButtonSito() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <div className="absolute right-full mr-3 top-1/2 transform -translate-y-1/2 bg-blue-dark text-cream text-sm px-3 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap font-montserrat">
        Scrivici su WhatsApp
        <div className="absolute left-full top-1/2 transform -translate-y-1/2 border-4 border-transparent border-l-blue-dark"></div>
      </div>
    </motion.button>
  )
}
